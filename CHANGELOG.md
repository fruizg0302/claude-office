...
- Rewrote renderer to use cell-based buffer instead of ANSI string overlay — fixes garbled output where escape codes leaked into visible text and desks/agents rendered at wrong positions
...
[0.1.1]: https://github.com/fruizg0302/claude-office/releases/tag/v0.1.1
